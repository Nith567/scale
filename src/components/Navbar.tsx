  ...
  return (
    <div>
      <header className="py-10 flex flex-col">
        <div className="flex flex-row justify-between items-end border-solid border-b border-b-neutral-800 pb-5">
          <p>
            Introducing the SEAL Leaderboards: the first truly expert-driven,
            trustworthy LLM contest.
          </p>
